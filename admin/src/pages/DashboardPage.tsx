...
const cards: Array<{ key: keyof DashboardCounts; label: string; note: string }> = [
  ...
  { key: "drafts", label: "草稿", note: "尚未發布內容" },
  { key: "needsValidation", label: "待檢查", note: "目前為草稿狀態" },
];
...
export function DashboardPage() {
  ...
  return <>
    ...
    <section className="coming-soon"><div><p className="eyebrow">Stage 5B-1</p><h2>文字內容管理已開放</h2><p>班級花絮與活動成果可建立及儲存 Cloud 草稿；媒體與發布仍將於後續階段開放。</p></div><div className="progress-ring" aria-label="文字管理已開放">文字<br />開放</div></section>
  </>;
}
