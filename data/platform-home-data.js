window.PLATFORM_HOME_DATA = {
  "meta": {
    "lastUpdated": "2026-06-28"
  },
  "hero": {
    "platformName": "邑米地方知識探索平台",
    "slogan": "探索地方．累積知識．連結生活",
    "intro": "整合地方知識、成果典藏與數位探索，帶您重新認識嘉義縣海區的文化、故事與生活。",
    "buttonText": "開始探索",
    "buttonHref": "#halls",
    "slides": [
      {
  ...
  "halls": [
    ...
    },
    {
      ...
      "iconSrc": "",
      "name": "地方探索",
      "description": "透過數位走讀與 AR 走讀認識赤蘭溪地方故事。",
      "href": "index.html#/digital/chilan-walk"
    },
    {
      "icon": "社",
      "iconSrc": "",
  ...
  "featuredResults": [
    ...
    },
    {
      ...
      "category": "背景知識",
      "title": "赤蘭溪地方知識",
      "description": "從流域故事、生態觀察與田野調查，延伸閱讀赤蘭溪地方記憶。",
  ...
  "latest": [
    {
      ...
      "href": "index.html#/digital/game"
    },
    {
      "type": "活動成果",
      "title": "地方走讀與田野記錄",
      "summary": "從觀察、訪談到整理，留下居民眼中的地方。",
      "date": "2026-06-18",
      "image": "assets/images/platform-home/latest-field.jpg",
      "href": "index.html#/overview"
    },
    {
      "type": "成果展示",
      "title": "學員創作與影像典藏",
      "summary": "以速寫、照片與作品，保存學習中的片刻。",
      "date": "2026-06-08",
  ...
  "about": {
    "text": "邑米地方知識探索平台以地方知識保存與傳承為核心，整合田野調查、口述歷史、生態觀察、老照片與學員成果。透過成果典藏與數位探索，讓居民、學生與訪客都能重新認識嘉義的土地，也讓每一次學習與公共參與持續累積。",
  ...
  "news": [
    {
      "date": "2026-06-28",
      "category": "平台更新",
      "title": "邑米地方知識探索平台 V1.0 首頁測試中",
      "href": "#"
    },
    {
      "date": "",
      "category": "預留",
      "title": "後續活動公告與課程資訊將於此處更新",
      "href": "#"
    }
  ]
}
